...
# Bot Information
BOT_TOKEN = environ.get("BOT_TOKEN", "7197628113:AAFN7rLNNhymJ3tDdO5I3arwspNQcUIPQGQ")
BOT_USERNAME = environ.get("BOT_USERNAME", "Filestorebot97bot") # your bot username without @
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002074170490"))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002016833241')).split()]
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002074170490'))
