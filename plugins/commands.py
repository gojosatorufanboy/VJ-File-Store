...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[InlineKeyboardButton('🔍 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/devilcartoonsoffical'),
            InlineKeyboardButton('🤖 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+5CUebHmDQRxjMTZl')
            ],[
        ...
        try:
            ...
            g = await msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                         InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback.data=f'generate_stream_link:{file_id}')
                     ]
                    ]
                )
            )
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[InlineKeyboardButton('🔍 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/devilcartoonsoffical'),
            InlineKeyboardButton('🤖  sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='t.me/+5CUebHmDQRxjMTZl')
            ],[
            InlineKeyboardButton('🤖 ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ', callback_data='clone')
            ],[
            InlineKeyboardButton('💁‍♀️ ʜᴇʟᴘ', callback_data='help'),
